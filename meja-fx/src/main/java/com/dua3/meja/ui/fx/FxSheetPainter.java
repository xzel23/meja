...
public class FxSheetPainter extends SheetPainterBase<FxSheetView, FxGraphicsContext> {
    ...
    FxSheetPainter(FxSheetView sheetView, CellRenderer cellRenderer) {
        super(sheetView);
    ...
    @Override
    protected void drawBackground(FxGraphicsContext gc) {
    ...
    @Override
    protected void drawLabel(FxGraphicsContext gc, Rectangle2f r, String text) {
        final Rectangle rd = sheetView.rectS2D(r);
    ...
    @Override
    protected void render(FxGraphicsContext g, Cell cell, Rectangle2f rect, Rectangle2f clipRect) {
        Rectangle rectD = sheetView.rectS2D(rect);
        Rectangle clipRectD = sheetView.rectS2D(clipRect);
